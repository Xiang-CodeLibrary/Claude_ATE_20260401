...
//--------------------------------------------------------------------------------
//Command: generate_target bd_2935.bd
//Design : bd_2935
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_2935,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_2935,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "mig_ddr3_microblaze_mcs.hwdef" *) 
module bd_2935
   (Clk,
    IO_addr_strobe,
    IO_address,
    ...
    TRACE_reg_write,
    TRACE_valid_instr);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_ASYNC_RESET Reset, CLK_DOMAIN bd_2935_Clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input Clk;
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 >  bd_2935 lmb_bram_I bd_2935 second_lmb_bram_I" *) 
  (* KEEP_HIERARCHY = "YES" *) 
  bd_2935_dlmb_cntlr_0 dlmb_cntlr
  ...
  bd_2935_ilmb_cntlr_0 ilmb_cntlr
  ...
  bd_2935_iomodule_0_0 iomodule_0
       (.Clk(Clk),
  ...
  bd_2935_lmb_bram_I_0 lmb_bram_I
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > bd_2935 dlmb_cntlr" *) 
  (* KEEP_HIERARCHY = "YES" *) 
  bd_2935_microblaze_I_0 microblaze_I
       (.Byte_Enable(dlmb_BE),
        .Clk(Clk),
        .DCE(dlmb_CE),
        .DReady(dlmb_READY),
  ...
  bd_2935_second_dlmb_cntlr_0 second_dlmb_cntlr
  ...
  bd_2935_second_ilmb_cntlr_0 second_ilmb_cntlr
  ...
  bd_2935_second_lmb_bram_I_0 second_lmb_bram_I
