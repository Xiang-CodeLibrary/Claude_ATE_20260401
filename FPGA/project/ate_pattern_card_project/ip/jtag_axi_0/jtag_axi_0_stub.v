...
//               d:/ATE_20260401/FPGA/project/ate_pattern_card_project/ip/jtag_axi_0/jtag_axi_0_stub.v
// Design      : jtag_axi_0
...
(* CHECK_LICENSE_TYPE = "jtag_axi_0,jtag_axi_v1_2_23_jtag_axi,{}" *) (* CORE_GENERATION_INFO = "jtag_axi_0,jtag_axi_v1_2_23_jtag_axi,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=jtag_axi,x_ipVersion=1.2,x_ipCoreRevision=23,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,RD_TXN_QUEUE_LENGTH=1,WR_TXN_QUEUE_LENGTH=1,M_AXI_ID_WIDTH=1,M_AXI_ADDR_WIDTH=32,FAMILY=virtexu,M_AXI_DATA_WIDTH=32,M_HAS_BURST=1,PROTOCOL=0}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
...
/* synthesis syn_force_seq_prim="aclk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 signal_clock CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME signal_clock, ASSOCIATED_BUSIF M_AXI, ASSOCIATED_RESET aresetn, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, INSERT_VIP 0" *) input aclk /* synthesis syn_isclock = 1 */;
